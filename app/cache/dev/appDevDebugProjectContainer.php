...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'mocal.experian.client' => 'getMocal_Experian_ClientService',
            'mocal.experian.manager' => 'getMocal_Experian_ManagerService',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9aa1f8b2aae835a5392181552419edd451f90969419a057365149331c4fb7c1a');
    ...
    /**
     * Gets the 'mocal.experian.client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mocal\Bundle\ExperianBundle\Model\Client\ExperianClient A Mocal\Bundle\ExperianBundle\Model\Client\ExperianClient instance.
     */
    protected function getMocal_Experian_ClientService()
    {
        return $this->services['mocal.experian.client'] = new \Mocal\Bundle\ExperianBundle\Model\Client\ExperianClient(17539, 'MTc1Mzk6MTAwMjQ5', 'cd91f919a5fd40b0b1c08d8f8eaac72c', 100249, 167, 'https://api.ccmp.eu/services/authorization/oauth2/token', 'https://api.ccmp.eu/services2/api/EmailCampaign', $this->get('logger'));
    }

    /**
     * Gets the 'mocal.experian.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mocal\Bundle\ExperianBundle\Model\ExperianManager A Mocal\Bundle\ExperianBundle\Model\ExperianManager instance.
     */
    protected function getMocal_Experian_ManagerService()
    {
        return $this->services['mocal.experian.manager'] = new \Mocal\Bundle\ExperianBundle\Model\ExperianManager($this->get('mocal.experian.client'), $this->get('logger'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Mocal/Bundle/ExperianBundle/Resources/views'), 'MocalExperian');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56e671f500ebf')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MocalExperianBundle' => 'Mocal\\Bundle\\ExperianBundle\\MocalExperianBundle',
            ...
            'experian.client_id' => 17539,
            'experian.consumer_key' => 'MTc1Mzk6MTAwMjQ5',
            'experian.consumer_secret' => 'cd91f919a5fd40b0b1c08d8f8eaac72c',
            'experian.cust_id' => 100249,
            'experian.entity_id' => 167,
            'experian.url_token' => 'https://api.ccmp.eu/services/authorization/oauth2/token',
            'experian.url_email_campaign' => 'https://api.ccmp.eu/services2/api/EmailCampaign',
            ...
            'mocal.experian.manager.class' => 'Mocal\\Bundle\\ExperianBundle\\Model\\ExperianManager',
            'mocal.experian.client.class' => 'Mocal\\Bundle\\ExperianBundle\\Model\\Client\\ExperianClient',
